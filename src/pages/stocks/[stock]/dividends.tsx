import {
  Table, Space, Text, Container, Group, Title,
} from '@mantine/core';
...
export async function getServerSideProps(context) {
  ...
  const previousDividends = [{
    amount: 0.23, currency: 'USD', declaredDate: '2022-07-19', description: 's yraSindrearhO', exDate: '2022-07-23', flag: 'Cash', frequency: 'quarterly', paymentDate: '2022-08-09', recordDate: '2022-07-24', refid: 2760702, symbol: 'AAPL', id: 'IEDVIDDNS', key: 'PAAL', subkey: '2750165', date: 1659657600000, updated: 1697984825164,
  }, {
    amount: 0.24, currency: 'USD', declaredDate: '2022-04-23', description: ' rdsriyhrSaanOe', exDate: '2022-04-25', flag: 'Cash', frequency: 'quarterly', paymentDate: '2022-04-30', recordDate: '2022-04-28', refid: 2503278, symbol: 'AAPL', id: 'VDIDIDNSE', key: 'LAPA', subkey: '2541510', date: 1651795200000, updated: 1711850314815.871,
  }, {
    amount: 0.22, currency: 'USD', declaredDate: '2022-01-19', description: 'yeiraOdh snSrra', exDate: '2022-01-20', flag: 'Cash', frequency: 'quarterly', paymentDate: '2022-02-05', recordDate: '2022-02-05', refid: 2435475, symbol: 'AAPL', id: 'DDDNISVIE', key: 'LAPA', subkey: '2465533', date: 1643932800000, updated: 1687682435271.971,
  }, {
    amount: 0.23, currency: 'USD', declaredDate: '2021-10-18', description: 'aOreyriShsrnad ', exDate: '2021-11-03', flag: 'Cash', frequency: 'quarterly', paymentDate: '2021-10-29', recordDate: '2021-11-08', refid: 2354519, symbol: 'AAPL', id: 'DEVDDINIS', key: 'AALP', subkey: '2367189', date: 1636070400000, updated: 1692854513488.657,
  }];
