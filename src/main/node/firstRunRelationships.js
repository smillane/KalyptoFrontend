...
const firstRunRelationships = new Map([[StockStatsBasicModel, stockStatsBasic], [StockLargestTradesModel,stockLargestTrades], [StockPreviousDividendsModel, stockPreviousDividends], [StockNextDividendsModel, stockNextDividends]]);

export default firstRunRelationships;