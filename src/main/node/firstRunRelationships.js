...
export default function firstRunRelationships() { return new Map([[StockStatsBasicModel, stockStatsBasic], [StockLargestTradesModel,stockLargestTrades], [StockPreviousDividendsModel, stockPreviousDividends], [StockNextDividendsModel, stockNextDividends]]) }